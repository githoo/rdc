...
class TemporalConvNet(object):
    ...
    def _TemporalBlock(self, value, n_inputs, n_outputs, kernel_size, stride, dilation, padding, dropout=0.8, level=0):
        ...
        self.output1 = tf.nn.dropout(tf.nn.relu(self.conv1), keep_prob=dropout)
        ...
        self.output2 = tf.nn.dropout(tf.nn.relu(self.conv2), keep_prob=dropout)
